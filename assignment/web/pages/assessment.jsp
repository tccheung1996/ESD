                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form action="questionPool.jsp" method="get">
                                <br>
                                <br>
                                ...
                                <center>
                                    ...
                                    <%
                                        ...
                                        for (int i = 0; i < abList.size(); i++) {
                                            ...
                                            out.print("<p>Max Number of Attempt:" + ab.getNumOfAttem() + "</p>");
                                            out.print("<p>From Date:" + ab.getFromDate() + "</p>");
                                            out.print("<p>To Date:" + ab.getToDate() + "</p>");
                                            out.print("</b>");
                                            out.print("</td>");
                                            ...
                                            out.print("<center>");
                                            out.print("</form>");
                                            out.print("<form action=\"handleAssessment\"><button class=\"button\">EDIT</button><input type=\"hidden\" name=\"moduleID\" value=\"" + moduleID + "\"><input type=\"hidden\" name=\"action\" value=\"editQuestion\" ><input type=\"hidden\" name=\"edit\"  value=\"" + ab.getAssID() + "\"></form>");
                                            out.print("<form method=\"get\" action=\"handleAssessment\"><button class=\"button1\">DELETE</button><input type=\"hidden\" name=\"moduleID\" value=\"" + moduleID + "\"><input type=\"hidden\" name=\"action\" value=\"delAssessment\" ><input type=\"hidden\" name=\"assID\"  value=\"" + ab.getAssID() + "\"></form>");
                                            out.print("</td>");
                                            out.print("</center>");
                                            out.print("</tr>");
