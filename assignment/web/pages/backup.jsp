           ...
           <jsp:include page="admin_nav_bar.jsp"/>      
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default"><br>
                            <button type="button" class="btn btn-primary" style="margin-left:1%;" id="add_class_btn" onclick="document.getElementById('add_class').style.display = 'none';">Add New Class</button><br>
                            ...
                            <!--
                                  <div class="form-group">
                                    <div class="col-md-4">
                                          <button type="button" class="btn btn-primary" style="margin-left:1%;">Add New Class</button> class
                                        <input type="text" placeholder="" class="form-control input-md" required="" style="width:100px;">
               ...
               for (int i = 0; i < students.size(); i++) {
                   ...
                   c.setClass_id(s.getClassID());
                   a.setAccount_id(s.getAccountID());
                   out.println("<tr  class='gradeC'>");
                   out.println("<td>" +s.getStudentID() + "</td>");
                   out.println("<td>" +c.getClass_name() + "</td>");
                   out.println("<td>" +s.getName() + "</td>");
                   out.println("<td>  <select class='form-control'><option>Student</option><option>Teacher</option>"
                                  +" <option>Administrator</option></select></td>");
                   out.println("<td>" +a.getEmail() + "</td>");
                   out.println("<td>********</td>");
                                   out.println("<td> <td><button type='button' class='btn btn-primary'>Edit</button>"
                                             +"<button type='button' class='btn btn-danger'>Delete</button></td></td>");
                   out.println("</tr>");
               } %>
