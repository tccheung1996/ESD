 ...
 * @author admin
 */
@WebServlet(name = "ShowManageAssessment", urlPatterns = {"/ShowManageAssessment"})

public class ShowManageAssessment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try {
            ...
            rd = getServletContext().getRequestDispatcher("/pages/manageAssessment.jsp");
            rd.forward(request, response);
